...
import 'package:dart_jsonpath/src/utility.dart';

import 'package:dart_jsonpath/src/JsonPathUtility.dart';

class JsonPathWriter extends JsonPathUtility {
  ...
  Map<String, Object> _addValueIntoMap(
    ...
    if (map.containsKey(nodeName) || _isArrayPathExist(map, nodeName)) {
      ...
      if (splitPath.isEmpty) {
        ...
        if (_ifPathIsArray(nodeName)) {
          if (null != data) {
            ...
            dataMap[insertNodeName] = _toList(data as List);
          }
        } else {
          Map<String, Object> temp =
              _toMap(data as LinkedHashMap<String, Object>);
          temp.addAll(nodeData as Map<String, Object>);
      ...
      if (splitPath.isNotEmpty) {
        if (_ifPathIsArray(nodeName)) {
          dataMap[insertNodeName] =
              _addValueInList(List.empty(), nodeName, nodeData, splitPath);
        } else {
          String nextNodeName = splitPath.elementAt(0);
          splitPath.removeAt(0);
          dataMap[insertNodeName] =
        ...
        try {
          if (_ifPathIsArray(nodeName)) {
            ...
            if (nodeData is String) {
              ...
              dataMap[insertNodeName] =
                  _toMap(nodeData as LinkedHashMap<String, Object>);
            }
          }
        } catch (e) {}
      }
  ...
  bool _isArrayPathExist(Map<String, Object> map, String nodeName) {
  ...
  Object _addIntoList(Object? data, Object nodeData, List<String> splitPath) {
    if (splitPath.isEmpty) {
      if (data is Map) {
        return _toMap(nodeData as LinkedHashMap<String, Object>,
            lastObject: data);
  ...
  Map<String, Object> _toMap(LinkedHashMap<String, Object> object,
    ...
    while (keysItr.moveNext()) {
      ...
      if (value is List) {
        ...
        value = _toMap(value as LinkedHashMap<String, Object>);
      }
      map[key] = value;
    }
    return map;
